    ...
    return (
        <label className={styles['theme-switch']}>
            ...
            <div className={styles['theme-switch__container']}>
                ...
                <div className={styles['theme-switch__shooting-star']}></div>
                <div className={styles['theme-switch__shooting-star-2']}></div>
                <div className={styles['theme-switch__meteor']}></div>
                ...
                <div className={styles['theme-switch__aurora']}></div>
